...
<center><h3>Header Registeration</h3></center>
<form onsubmit="return Submit()" action="/Victim/HeaderController" name="sample"> 
<!-- adding Header List -->
<table align="center">

<tr>
<td>Family Header Name</td>
<td><input type="text" name="FamilyHeaderName" id="FamilyHeaderName" class="form-control" required/></td>
</tr>
...
<td>
    <div class="radio">
     <label><input type="radio" name="optradio" id="optradio" class="form-control" value="Male">Male</label>
     </div>
     <div class="radio">
     <label><input type="radio" name="optradio" id="optradio" class="form-control" value="Female">Female</label>
     </div>
</td>
</tr>
