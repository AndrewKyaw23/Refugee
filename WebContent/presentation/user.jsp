												...
												<script>
													...
													function confirmDelete() {
														...
														var r=confirm("Are you sure to delete this row");
												  		if(r){
												  			location.href="/Victim/UserController?page=remove&id="+arguments[0];
												  		}
													}
												</script>
									        </td>
					      ...
					      <!-- Modal content-->
					      	<div class="modal-content">
					        	<div class="modal-header w3-container w3-light-blue p10">
					       		...
					       		<form onsubmit="return validate()" name="sample" action="/Victim/UserController" method="post">
											...
											<div class="row">
												...
												<script type="text/javascript">
													function AddNewUserLevel(){
															...
															alert(uln);
														var method="post";
														var path="/Victim/User_LevelController";
					      ...
					      <!-- Modal content-->
					      	<div class="modal-content">
					        	<div class="modal-header w3-container w3-light-blue p10">
					       		...
					       		<form onsubmit="return confirmEdit()" name="sample" action="/Victim/UserController">
						        <div class="modal-body p10">
						        	<div class="row">
						          		<div class="col-sm-1"></div>
