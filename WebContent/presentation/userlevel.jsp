...
<script>
	 function existOrNot(){
		 if(arguments[0]=="1"){
			 ...
			 if(r){
				 location.href="/Victim/User_LevelController?page=sureRemove&id="+arguments[2];
			 }
			 ...
			 if(confirm("Are you sure to Edit!")){
				 location.href="/Victim/User_LevelController?page=sureEdit&txtId="+arguments[2]+"&txtName="+arguments[3]
						...
						<td class="dropdown">
							...
							<script>
								...
								function confirmDelete() {
										location.href="/Victim/User_LevelController?page=remove&ulid="+arguments[0];
								}
							</script>
						</td>
						<%
	...
	<div class="modal fade" id="addNew" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form action="/Victim/User_LevelController">
	...
	<div class="modal fade" id="rowEd" role="dialog">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<form name="sample" action="/Victim/User_LevelController">
					<div class="modal-body p10">
						<center>
							<table>
								<tr>
