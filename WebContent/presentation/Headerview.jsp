...
<div class="row">
  ...
  <h1>Header Information</h1>
      	 <input id="myInput" type="text" placeholder="Search Header...">
      	 <br>
      	 <!-- search script -->
      	 <script>
  	...
  	<table class="table table-bordered table-striped" id="ex">
			...
			<tr>
		      ...
		      <li class="w3-container w3-hover-blue p10" data-toggle="modal" data-target="#rowEd"
			    onclick="submit1(
			    '<%out.print(ca.getHeader_id());%>',
			    '<%out.print(ca.getFamilyHeaderName());%>',
			    '<%out.print(ca.getNrc());%>',
			    '<%out.print(ca.getBOD());%>',
			    '<%out.print(ca.getAge());%>',
			    ...
			    <td><ul> 
			   <li class="w3-container w3-hover-blue p10" onclick="confirmDelete('<%out.print(ca.getHeader_id());%>')">
					 <span class="glyphicon glyphicon-remove-circle"></span><a href="/Victim/HeaderController?page=remove&Header_id=<%out.print(ca.getHeader_id());%>">Delete</a>
			   </li>
			   </ul> </td>
		  </tr>
		    <script >
													function submit(){
														document.getElementById("getHeader_id").value=arguments[0];
														document.getElementById("getFamilyHeaderName").value=arguments[1];
													...
													function confirmDelete() {
														...
														var r=confirm("Are you sure to delete this row");
												  		if(confirm("Do you want to delete really!!")){
												  			location.href="/Victim/HeaderController?page=remove&Header_id="+arguments[0];
												  		}
												  		else{
												  			alert("Cann't delete.....")
												  		}
					      	...
					      	<div class="modal-content">
					        	<div class="modal-header w3-container w3-light-blue p10">
					       		...
					       		<script>
					       		 ...
					       		 function submit1(){
					       			 document.getElementById("idHeader_id").value=arguments[0];
					       			 document.getElementById("idFamilyHeaderName").value=arguments[1];
  ...
  <form onsubmit="return confirmEdit()" name="sample" action="/Victim/HeaderController">
						        <div class="modal-body p10">
									        ...
									        <tr>
										        <td></td>
										        <td><input
										              class="u-full-width form-control" type="hidden" name="idHeader_id" value=" " id="idHeader_id"/>
										         </td></tr>
									       <tr> 
									       		<td><label for="lblName">Enter New Family Header Name</label></td>
									       		<td><input
									              class="u-full-width form-control" type="text" name="idFamilyHeaderName" id="idFamilyHeaderName" value=" " required/></td>
									        </tr>
									        <tr>
									        <td>&nbsp;</td><td>&nbsp;</td>
									        </tr>
									        ...
									        <td>&nbsp;</td><td>&nbsp;</td>
									           ...
									           <tr> 
									       		...
									       		<td><input
									              class="u-full-width form-control" type="text" name="idBOD" id="idBOD" value=" " required/></td>
									        </tr>
									        <tr>
									        <td>&nbsp;</td><td>&nbsp;</td>   
									        </tr>
									        ...
									        <td>&nbsp;</td><td>&nbsp;</td>
									           ...
									           <tr> 
									       		...
									       		<td><input
									              class="u-full-width form-control" type="text" name="idArrivalDate" id="idArrivalDate" value=" " required/></td>
									        </tr>
									        <tr>
									        <td>&nbsp;</td><td>&nbsp;</td>   
									        </tr>
									        ...
									        <td><label for="lblDepartureDate">Enter New  DepartureDate</label></td><td><input
									              class="u-full-width form-control" type="text" name="idDepartureDate" id="idDepartureDate" value=" " required/></td>
									        </tr>    
									          <tr>
									        <td>&nbsp;</td><td>&nbsp;</td>
									        </tr>
